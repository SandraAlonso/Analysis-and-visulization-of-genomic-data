...
matrix<-as.matrix(tablecsv) # For using boxplot function it is mandatory to create a matrix from the given data
boxplot(matrix)
```
...
plot(df12, xlim =c(-1.1,0.1),main= "PC1 vs. PC2")
text(df12,labels=row.names(df12),pos=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2))

plot(df13, xlim=c(-1.3,0.1), ylim=c(-0.6,0.5),main = "PC1 vs. PC3")
